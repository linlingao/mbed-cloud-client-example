#ifndef _ICM20602_I2C_H_
#define _ICM20602_I2C_H_
...
class ICM20602 {
    public:
        void    whoAmI(I2C *i2c);
        void    init(I2C *i2c);
        int16_t getAccXvalue(I2C *i2c);
        int16_t getAccYvalue(I2C *i2c);
        int16_t getAccZvalue(I2C *i2c);
        int16_t getGyrXvalue(I2C *i2c);
        int16_t getGyrYvalue(I2C *i2c);
        int16_t getGyrZvalue(I2C *i2c);
        int16_t getIMUTemp(I2C *i2c);
        float   setAccRange(I2C *i2c, int Ascale);
        float   setGyroRange(I2C *i2c, int Gscale);
};

#endif // _ICM20602_I2C_H_
